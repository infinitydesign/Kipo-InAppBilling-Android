 ...
 */
public class IndeterminateHorizontalProgressDrawable extends ir.kipo.billing.libraries.materialprogressbar.BaseIndeterminateProgressDrawable
        implements ir.kipo.billing.libraries.materialprogressbar.MaterialProgressDrawable, ShowBackgroundDrawable {
    ...
    public IndeterminateHorizontalProgressDrawable(Context context) {
        ...
        mAnimators = new Animator[]{
                ir.kipo.billing.libraries.materialprogressbar.Animators.createIndeterminateHorizontalRect1(mRect1TransformX),
                ir.kipo.billing.libraries.materialprogressbar.Animators.createIndeterminateHorizontalRect2(mRect2TransformX)
        };
    }
