...
import ir.kipo.billing.libraries.materialprogressbar.internal.DrawableCompat;
...
public class MaterialProgressBar extends ProgressBar {
    ...
    private void applyTintForDrawable(Drawable drawable, ColorStateList tint,
        ...
        if (hasTint || hasTintMode) {
            ...
            if (hasTint) {
                if (drawable instanceof ir.kipo.billing.libraries.materialprogressbar.TintableDrawable) {
                    //noinspection RedundantCast
                    ((ir.kipo.billing.libraries.materialprogressbar.TintableDrawable) drawable).setTintList(tint);
                } else {
            ...
            if (hasTintMode) {
                if (drawable instanceof ir.kipo.billing.libraries.materialprogressbar.TintableDrawable) {
                    //noinspection RedundantCast
                    ((ir.kipo.billing.libraries.materialprogressbar.TintableDrawable) drawable).setTintMode(tintMode);
                } else {
                    logDrawableTintWarning();
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
