 ...
 */
public class IndeterminateCircularProgressDrawable extends ir.kipo.billing.libraries.materialprogressbar.BaseIndeterminateProgressDrawable
        implements ir.kipo.billing.libraries.materialprogressbar.MaterialProgressDrawable {
    ...
    public IndeterminateCircularProgressDrawable(Context context) {
        ...
        mAnimators = new Animator[]{
                ir.kipo.billing.libraries.materialprogressbar.Animators.createIndeterminate(mRingPathTransform),
                ir.kipo.billing.libraries.materialprogressbar.Animators.createIndeterminateRotation(mRingRotation)
        };
    }
